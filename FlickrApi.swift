...
//  language
//
//  Created by Arif Khan on 11/7/16.
...
class FlickrApi : NSObject {
    ...
    func taskForGETMethod(_ latitude: Double, longitude: Double, completionHandlerForGET: @escaping (_ result: AnyObject?, _ error: String?) -> Void) -> URLSessionDataTask {
        ...
        let url = "https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=4a7e6ee4e5283511cd06065e7a188248&user_id=146350684%40N06&tags=urdu&format=rest&auth_token=72157676290381955-1147006404b03c20&api_sig=060e2258bf4bf2f2743d8fb7b731f796"
